  ...
  return (
    <div className="flex h-full flex-col">
      <div>
        ...
        <p className="text-md mt-1 font-medium text-zinc-500">최근 상담 데이터 20건 분석 ({dummyData.lastUpdated} 기준)</p>
      </div>
      <div className="mt-6 flex flex-col gap-6">
        <h3 className="text-[24px] font-bold tracking-tighter text-zinc-700">{dummyData.headline}</h3>
        <InsightGauge score={dummyData.score} />
      </div>
