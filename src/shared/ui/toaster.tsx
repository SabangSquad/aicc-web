  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            'group flex w-full items-center rounded-4xl border border-gray-200/60 bg-white/80 px-4 py-3.5 text-gray-800 shadow-[0_8px_30px_rgb(0,0,0,0.12)]',
          title: ' !text-base text-zinc-900',
