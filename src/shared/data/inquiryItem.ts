...
export const items: InquiryType[] = [
  {
    ...
    title: '배송 지연 문의 (주문번호: 20251025-001)',
    content: '어제 도착 예정이었던 상품이 아직도 배송 준비 중입니다. 확인 부탁드립니다. 주문번호 20251025-001 입니다.',
    status: 'pending',
    aiSummary: '고객(최민준)이 주문(20251025-001)의 배송 지연에 대해 문의함. 예정일이 지났으나 아직 배송 준비 중.',
  ...
  },
  {
    ...
    closed_at: '2025-10-28T10:00:00Z',
    memo: '답변 완료',
    emotion: 'neutral',
    phone: '010-1111-2222',
    category: '제품',
  ...
  },
  {
    ...
    title: '환불 요청 건',
    content: '주문 취소했는데 아직 환불이 안 들어왔어요. 언제쯤 처리되나요? 주문번호: 20251024-005',
    status: 'pending',
    aiSummary: '고객(윤서아)이 취소한 주문(20251024-005)의 환불 처리 일정을 문의함.',
  ...
  },
  {
    ...
    content:
      '오늘 주문한 상품(주문번호: 20251028-002) 배송지를 A가 아니라 B로 변경해주세요. 아직 발송 전인 것 같습니다.',
    status: 'completed',
    aiSummary: '고객(강지후)이 당일 주문 건의 배송지 변경을 요청함 (처리 완료).',
    createdAt: '2025-10-28T09:30:00Z',
    closed_at: '2025-10-28T10:15:00Z',
    memo: '배송팀 처리 완료',
    emotion: 'neutral',
    phone: '010-5555-6666',
    category: '배송',
  ...
  },
  {
    ...
    closed_at: '2025-10-26T09:00:00Z',
    memo: '개발팀 처리 완료',
    emotion: 'neutral',
    phone: '010-7777-8888',
    category: '기타',
