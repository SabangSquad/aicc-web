...
export function ChatSidebar() {
  ...
  return (
    <aside
      className={`hidden md:flex flex-col bg-zinc-100 border-r border-white/60 transition-all duration-300 ease-in-out ${
        isOpen ? 'w-72 p-5' : 'w-[80px] p-4 items-center'
      }`}
    >
      <div className={`flex items-center w-full mb-8 ${isOpen ? 'justify-between' : 'justify-center'}`}>
      ...
      {isOpen && (
        <div className="space-y-2 flex-1 overflow-y-auto pr-2 w-full transition-opacity duration-300">
