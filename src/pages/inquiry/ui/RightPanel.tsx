    ...
    <div className="flex h-full items-center justify-center">
      <div className="flex h-full w-full flex-col">
        <div className="border-b p-6">
          ...
          <p className="mt-1 text-sm text-muted-foreground">{new Date(selectedInquiry.created_at).toLocaleString('ko-KR')}</p>
        </div>
          ...
          <div className="space-y-8 py-6">
            ...
            <div className="flex flex-row gap-6">
              ...
              <div className="flex-1">
                ...
                <Textarea value={memo} onChange={handleMemoChange} placeholder="메모를 입력하세요..." className="min-h-[120px] mb-2" />
